...
\vspace{\entryskip}
我已在 SIGMOD、KDD、NeurIPS、WWW、AAAI、IJCAI 和 IEEE TKDE 等重要会议和期刊发表 33 篇论文，其中一项工作获选 NeurIPS 2025 口头报告。
其中 17 篇由我以第一作者、共同第一作者或主要学生作者身份主导完成。
...
\pubentry{IEEE TKDE, 2025}{\href{https://ieeexplore.ieee.org/document/10818577}{论文} \,/\, \href{https://github.com/Logan-Lin/UniTE}{代码}}
...
\pubentry{IEEE TKDE, 2025}{\href{https://ieeexplore.ieee.org/document/11004614}{论文} \,/\, \href{https://github.com/Logan-Lin/UVTM}{代码}}
...
\pubentry{NeurIPS, 2025}{\href{https://neurips.cc/virtual/2025/oral/117509}{口头报告} \,/\, \href{https://neurips.cc/virtual/2025/poster/117508}{海报}}
...
\pubentry{IEEE TKDE, 2023}{\href{https://ieeexplore.ieee.org/abstract/document/10375102}{论文} \,/\, \href{https://github.com/Logan-Lin/MMTEC}{代码}}
...
{在路段之间和单个路段内部的观测均较稀疏时，补全路网中细粒度且随时间变化的交通状态，如特定时段各路段的行驶速度。该方法估计每个路段和时段可能交通状态的完整范围，而非单一数值。}
...
{结合路网结构与描述物理环境和区域背景的文本，学习道路网络中的路径表示，补充了以往方法忽略的语境信息。融合后的表示提升了路径排序和出行时间估计等任务在少量或无标注数据场景中的精度。}
...
\pubentry{SIGMOD, 2024}{\href{https://dl.acm.org/doi/10.1145/3617337}{论文} \,/\, \href{https://github.com/Logan-Lin/DOT}{代码}}
...
{基于扩散概率模型的材料逆向设计}
{}
{用扩散概率模型理解材料的化学成分、结构和性能关系，并逆向设计新材料。}
