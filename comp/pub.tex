...
\pubentry{Advanced Materials, 2026, IF 29.1}{\href{https://doi.org/10.1002/adma.202522493}{论文} \,/\, \href{https://arxiv.org/abs/2509.13916}{预印本} \,/\, \href{https://github.com/Logan-Lin/AMDEN-code}{代码}}
...
\pubentry{IJCAI, 2026, CCF-B}{\href{https://arxiv.org/abs/2603.29837}{预印本} \,/\, \href{https://github.com/Logan-Lin/DiSGMM-code}{代码}}
...
{通过建模车辆、骑行者和行人如何响应彼此与交通信号，以及谁该给谁让行，预测他们在城市路口的未来路径。该方法先粗略勾勒出每条路径，使预测在更长时间内保持可靠，再分阶段补充细节，从而提升真实路口数据上的预测精度。}

\pubentry{KDD, 2026, CCF-A}{\href{https://arxiv.org/abs/2512.21685}{预印本}}
...
\pubentry{NeurIPS, 2025, CCF-A}{\href{https://neurips.cc/virtual/2025/poster/115959}{海报}}
...
\pubentry{NeurIPS, 2025, CCF-A}{\href{https://neurips.cc/virtual/2025/oral/117509}{口头报告} \,/\, \href{https://neurips.cc/virtual/2025/poster/117508}{海报} \,/\, \href{https://arxiv.org/abs/2505.12672}{预印本}}
...
\pubentry{NeurIPS, 2025, CCF-A}{\href{https://neurips.cc/virtual/2025/poster/117945}{海报} \,/\, \href{https://arxiv.org/abs/2410.14281}{预印本}}
...
\pubentry{IEEE TKDE, 2025, IF 11.6}{\href{https://ieeexplore.ieee.org/document/11004614}{论文} \,/\, \href{https://arxiv.org/abs/2402.07232}{预印本} \,/\, \href{https://github.com/Logan-Lin/UVTM}{代码}}
...
\pubentry{IJCAI, 2025, CCF-A}{\href{https://www.ijcai.org/proceedings/2025/411}{论文} \,/\, \href{https://arxiv.org/abs/2405.12459}{预印本} \,/\, \href{https://github.com/Zeru19/PLM4Traj}{代码}}
...
\pubentry{IEEE TKDE, 2025, IF 11.6}{\href{https://ieeexplore.ieee.org/document/10818577}{论文} \,/\, \href{https://arxiv.org/abs/2407.12550}{预印本} \,/\, \href{https://github.com/Logan-Lin/UniTE}{代码}}
...
\pubentry{WWW, 2025, CCF-A}{\href{https://openreview.net/forum?id=KmMSQS6tFn}{论文} \,/\, \href{https://github.com/decisionintelligence/Path-LLM}{代码}}
...
\pubentry{AAAI, 2025, CCF-A}{\href{https://ojs.aaai.org/index.php/AAAI/article/view/33350}{论文} \,/\, \href{https://arxiv.org/abs/2408.12809}{预印本}}
...
\pubentry{NeurIPS, 2024, CCF-A}{\href{https://openreview.net/forum?id=0feJEykDRx}{论文} \,/\, \href{https://neurips.cc/virtual/2024/poster/96914}{海报}}
...
\pubentry{SIGMOD, 2024, CCF-A}{\href{https://dl.acm.org/doi/10.1145/3617337}{论文} \,/\, \href{https://arxiv.org/abs/2307.03048}{预印本} \,/\, \href{https://github.com/Logan-Lin/DOT}{代码}}
...
\pubentry{IEEE TKDE, 2023, IF 8.9}{\href{https://ieeexplore.ieee.org/abstract/document/10375102}{论文} \,/\, \href{https://arxiv.org/abs/2207.14539}{预印本} \,/\, \href{https://github.com/Logan-Lin/MMTEC}{代码}}
...
\pubentry{IEEE TKDE, 2022, IF 8.9}{\href{https://ieeexplore.ieee.org/abstract/document/9351627}{论文} \,/\, \href{https://github.com/Logan-Lin/TALE}{代码}}
...
\pubentry{AAAI, 2021, CCF-A}{\href{https://ojs.aaai.org/index.php/AAAI/article/view/16548}{论文} \,/\, \href{https://github.com/Logan-Lin/CTLE}{代码}}
...
\pubentry{IEEE TKDE, 2026, IF 11.6}{\href{https://ieeexplore.ieee.org/document/11589565}{论文} \,/\, \href{https://github.com/guoshnBJTU/STKGRisk}{代码}}
...
{帮助城市在历史事故记录稀疏的情况下，识别最可能发生交通事故的地点。该方法综合道路、交通、天气和地点信息，在街道和区域两个层面预测风险，为提前预警和安全出行提供支持。}

\pubentry{KDD, 2026, CCF-A}{}
...
{通过先依据已有观测在不同位置和时间上的整体规律构建粗略估计，再只用两步加以修正，来补全交通数据中的缺失值，而同类方法通常需要几十步。这使得该方法的速度提升十倍以上，补全精度也更高，即使在绝大多数读数缺失的情况下依然如此。}
...
{预测十字路口、环岛等路口场景中车辆的未来路径，只需少量甚至无需额外训练数据，就能迁移到此前未见过的路口。该方法将每辆车的历史运动记录与展示道路布局和周边交通运动状况的图像相结合，使预测能够依托整个场景的信息。}

\pubentry{DASFAA, 2026, CCF-B}{\href{https://link.springer.com/chapter/10.1007/978-981-92-0375-8_24}{论文}}
...
\pubentry{KDD, 2026, CCF-A}{\href{https://arxiv.org/abs/2509.00053}{预印本}}
...
\pubentry{AAAI, 2026, CCF-A}{\href{https://ojs.aaai.org/index.php/AAAI/article/view/37139}{论文} \,/\, \href{https://arxiv.org/abs/2511.12489}{预印本}}
...
\pubentry{AAAI, 2026, CCF-A}{\href{https://ojs.aaai.org/index.php/AAAI/article/view/38581}{论文} \,/\, \href{https://arxiv.org/abs/2601.04572}{预印本}}
...
\pubentry{KDD, 2025, CCF-A}{\href{https://dl.acm.org/doi/10.1145/3690624.3709325}{论文} \,/\, \href{https://arxiv.org/abs/2412.10859}{预印本} \,/\, \href{https://github.com/decisionintelligence/DUET}{代码}}
...
\pubentry{IEEE TKDE, 2024, IF 10.4}{\href{https://www.computer.org/csdl/journal/tk/5555/01/10679607/20b3hlbjBOo}{论文} \,/\, \href{https://arxiv.org/abs/2402.07369}{预印本} \,/\, \href{https://github.com/wtl52656/Diff-RNTraj}{代码}}
...
\pubentry{IEEE TKDE, 2024, IF 10.4}{\href{https://ieeexplore.ieee.org/document/10836764}{论文}}
...
\pubentry{IEEE TKDE, 2024, IF 10.4}{\href{https://www.computer.org/csdl/journal/tk/5555/01/10517676/1WCj0j0FljW}{论文} \,/\, \href{https://arxiv.org/abs/2404.19141}{预印本} \,/\, \href{https://github.com/wtl52656/MM-STGED}{代码}}
...
\pubentry{KBS, 2024, IF 7.6}{\href{https://www.sciencedirect.com/science/article/pii/S0950705123010730}{论文} \,/\, \href{https://github.com/wtl52656/IAGCN}{代码}}
...
\pubentry{IEEE TKDE, 2024, IF 10.4}{\href{https://ieeexplore.ieee.org/document/10613424}{论文} \,/\, \href{https://arxiv.org/abs/2407.15899}{预印本}}
...
\pubentry{AAAI, 2023, CCF-A}{\href{https://ojs.aaai.org/index.php/AAAI/article/view/25546}{论文} \,/\, \href{https://github.com/LetianGong/CACSR}{代码}}
...
\pubentry{ESWA, 2023, IF 7.5}{\href{https://www.sciencedirect.com/science/article/pii/S0957417423012241}{论文}}
...
\pubentry{APIN, 2023, IF 3.4}{\href{https://link.springer.com/article/10.1007/s10489-023-05057-7}{论文}}
...
\pubentry{NeurIPS, 2023, CCF-A}{\href{https://openreview.net/forum?id=y08bkEtNBK}{论文} \,/\, \href{https://github.com/Water2sea/WITRAN}{代码}}
