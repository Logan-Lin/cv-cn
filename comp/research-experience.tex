\section*{科研经历}
本节介绍我的研究方向，并列出各方向的代表性论文、项目和报告。
\textbf{粗体}标注本人姓名。星号（*）表示同等贡献。
\listsnote

\subsection*{轨迹表示学习}
轨迹表示学习是我的主要研究方向之一，旨在为时空轨迹数据学习可通用于多种下游任务的表示。该方向也包括构建能同时处理多种任务和场景的轨迹基座模型。
...
\subsection*{时空数据挖掘}
时空数据挖掘是我的另一个主要研究方向，也涵盖上述轨迹表示学习方向。该方向研究如何从带有时间和空间信息的大规模数据中发现并利用模式。这类数据通常来自交通场景。
...
\subsection*{人工智能材料科学}
人工智能材料科学是我的新兴研究方向，旨在应用人工智能技术，加速新型材料的发现，突破传统材料设计方法的局限。
